...
-- two weblog columns renamed
    alter table weblog add column visible bit default 1 not null; 
...
-- Allow users to order their weblog categories (zero-based)
    alter table weblogcategory add column position integer default 0 not null; 
...
-- Adding blog-specific web analytics (e.g. Google Analytics) tracking code
    alter table weblog add column analyticscode longvarchar default null;
