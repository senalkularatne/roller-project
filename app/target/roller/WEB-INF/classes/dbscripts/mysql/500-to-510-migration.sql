...
-- two weblog columns renamed
    alter table weblog add column visible tinyint(1) default 1 not null;  
...
update bookmark_folder set name = 	concat(name, id) 
 where name = 'default';
...
update roller_mediafiledir set name = 	concat(name, id) 
 where name = 'default';
